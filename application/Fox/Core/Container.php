 ...
 * 服务容器
 * */
class Container extends Loader
{
    # 储存临时数据 
    protected $storage;
    ...
    {
        if (! $abstract) {
            throw new InternalServerError("Can't inject service because abstract name is empty");
        }
        if (! is_object($instance)) {
            throw new InternalServerError('Inject faild, the service must be object');
        }
