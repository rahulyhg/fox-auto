...
class Permission
{
                ...
                if (file_exists($item)) {
                    ...
                    if ($type == 'writable') {
                        ...
                        if (is_dir($item)) {
                            ...
                            try {
                                $res &= $this->fileManager->putContents(array($item, $name), 'test');
                                $res &= $this->fileManager->removeFile($name, $item);
                            } catch (\Exception $e) {
                                $res = false;
                            }
                        }
     ...
     * e.g. array('application/Fox/Controllers/Email.php', 'application/Fox/Controllers/Import.php'), result is array('application/Fox/Controllers')
     *
