...
namespace Fox\ORM\Repositories;

use \Fox\ORM\EntityManager;
use \Fox\ORM\EntityFactory;
use \Fox\ORM\EntityCollection;
use \Fox\ORM\Entity;
use \Fox\ORM\IEntity;


class RDB extends \Fox\ORM\Repository
{
    /**
     * @var Object Mapper.
     */
    ...
    public function countRelated(Entity $entity, $relationName, array $params = array())
    {
        ...
        $entityName = $entity->relations[$relationName]['entity'];
        $this->entityManager->getRepository($entityName)->handleSelectParams($params);
