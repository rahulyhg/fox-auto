...
abstract class Mapper implements IMapper
{
    ...
    protected $collectionClass = "\\Fox\\ORM\\EntityCollection";
    ...
    public function __construct(PDO $pdo, \Fox\ORM\EntityFactory $entityFactory, Query\Base $query) {
        $this->pdo = $pdo;
        $this->query = $query;
...
//                 $sql = $this->composeUpdateQuery($relTable, $setPart, $wherePart);
                $sql = "DELETE FROM $relTable WHERE $wherePart";
    ...
    public function delete(IEntity $entity)
    {
        ...
        $sql = 'DELETE FROM ' . $this->toDb($entity->getEntityType()) 
            . ' WHERE `id` = '  . $this->pdo->quote($entity->id);
