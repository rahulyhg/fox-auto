...
Fox.define('views/record/detail', ['views/record/base', 'view-record-helper'], function (Dep, ViewRecordHelper) {
    ...
    return Dep.extend({
        ...
        getFieldViews: function (withHidden) {
            ...
            if (this.hasView('middle')) {
                _.extend(fields, Fox.Utils.clone(this.getView('middle').getFieldViews(withHidden)));
            }
            if (this.hasView('side')) {
