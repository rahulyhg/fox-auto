...
Fox.define('views/record/detail-bottom', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        setupPanels: function () {
            ...
            this.panelList = Fox.Utils.clone(this.getMetadata().get('clientDefs.' + scope + '.bottomPanels.' + this.mode) || this.panelList || []);
