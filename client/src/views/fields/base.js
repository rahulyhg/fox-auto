...
Fox.define('views/fields/base', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        setMode: function (mode) {
            ...
            if (!(property in this)) {
                this[property] = 'fields/' + Fox.Utils.camelCaseToHyphen(this.type) + '/' + this.mode;
            }
        ...
        validate: function () {
            for (var i in this.validations) {
                var method = 'validate' + Fox.Utils.upperCaseFirst(this.validations[i]);
