...
Fox.define('views/fields/email', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        data: function () {
            ...
            if (this.mode == 'edit') {
                emailAddressData = Fox.Utils.clone(this.model.get(this.dataFieldName));
        ...
        events: {
            ...
            'click [data-action="addEmailAddress"]': function () {
                var data = Fox.Utils.cloneDeep(this.fetchEmailAddressData());
