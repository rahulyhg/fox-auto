...
Fox.define('views/fields/array', ['views/fields/base', 'lib!Selectize'], function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.listenTo(this.model, 'change:' + this.name, function () {
                this.selected = Fox.Utils.clone(this.model.get(this.name));
            }, this);
        ...
        fetch: function () {
            var data = {};
            data[this.name] = Fox.Utils.clone(this.selected || []);
            return data;
        },
