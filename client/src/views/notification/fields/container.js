...
Fox.define('views/notification/fields/container', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        process: function () {
            ...
            var viewName = this.getMetadata().get('clientDefs.Notification.itemViews.' + type) || 'views/notification/items/' + Fox.Utils.camelCaseToHyphen(type);
        ...
        processNote: function (data) {
            ...
            this.getModelFactory().create('Note', function (model) {
                ...
                var viewName = this.getMetadata().get('clientDefs.Note.itemViews.' + data.type) || 'views/stream/notes/' + Fox.Utils.camelCaseToHyphen(data.type);
                this.createView('notification', viewName, {
                    model: model,
                    isUserStream: true,
                    el: this.params.containerEl + ' li[data-id="' + this.model.id + '"]',
