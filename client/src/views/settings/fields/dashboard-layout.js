...
Fox.define('views/settings/fields/dashboard-layout', ['views/fields/base', 'lib!gridstack'], function (Dep, Gridstack) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            this.dashboardLayout = Fox.Utils.cloneDeep(this.model.get(this.name) || []);
            ...
            this.dashletsOptions = Fox.Utils.cloneDeep(this.model.get('dashletsOptions') || {});
        ...
        editDashlet: function (id, name) {
            ...
            options = Fox.Utils.cloneDeep(options);
            ...
            Object.keys(defaultOptions).forEach(function (item) {
                ...
                options[item] = Fox.Utils.cloneDeep(defaultOptions[item]);
            }, this);
        ...
        fetch: function () {
            ...
            if (!this.dashboardLayout || !this.dashboardLayout.length) {
                ...
                data[this.name] = Fox.Utils.cloneDeep(this.dashboardLayout);
            }

            data['dashletsOptions'] = Fox.Utils.cloneDeep(this.dashletsOptions);
