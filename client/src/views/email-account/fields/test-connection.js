...
Fox.define('views/email-account/fields/test-connection', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        test: function () {
            ...
            $.ajax({
                ...
                $btn.removeClass('disabled');
                Fox.Ui.success(this.translate('connectionIsOk', 'messages', 'EmailAccount'));
            }.bind(this));
