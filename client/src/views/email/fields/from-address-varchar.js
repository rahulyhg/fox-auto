...
Fox.define('views/email/fields/from-address-varchar', 'views/fields/varchar', function (Dep) {
        ...
        createPerson: function (scope, address) {
            ...
            this.createView('create', viewName, {
                ...
                this.listenTo(view, 'after:save', function (model) {
                    var nameHash = Fox.Utils.clone(this.model.get('nameHash') || {});
                    var typeHash = Fox.Utils.clone(this.model.get('typeHash') || {});
                    var idHash = Fox.Utils.clone(this.model.get('idHash') || {});
