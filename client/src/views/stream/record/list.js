...
Fox.define('views/stream/record/list', 'views/record/list-expanded', function (Dep) {
    ...
    return Dep.extend({
        ...
        buildRow: function (i, model, callback) {
            ...
            var viewName = this.itemViews[type] || 'views/stream/notes/' + Fox.Utils.camelCaseToHyphen(type);
