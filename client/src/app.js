...
Fox.define(
    ...
    var App = function (options, callback) {
        ...
        this.id = options.id || 'CRM-application-id';
    ...
    _.extend(App.prototype, {
        ...
        getController: function (name, callback) {
            ...
            if (!(name in this.controllers)) {
                try {
                    ...
                    Fox.require(className, function (controllerClass) {
        ...
        initView: function () {
            ...
            this.viewLoader = function (viewName, callback) {
                Fox.require(Fox.Utils.composeViewClassName(viewName), callback);
            }.bind(this);
            ...
            $.ajaxSetup({
                beforeSend: function (xhr, options) {
                    if (!options.local && self.url) {
                        options.url = Fox.Utils.trimSlash(self.url) + '/' + options.url;
                    }
