...
var Fox = Fox || {classMap:{}};

(function (Fox, _, $) {

    var root = this;

    Fox.Loader = function (cache, cacheTimestamp) {
    ...
    Fox.require = function (subject, callback, context, errorCallback) {
        if (context) {
            callback = callback.bind(context);
        }
        Fox.loader.require(subject, callback, errorCallback);
    }
