    ...
    <style>
        ...
        .top_l {float:left; margin-top: -20px; margin-bottom: -17px;}
...
<div class="mobile" >
    ...
    <div class="baoliao" >
        <div class="user_nav_list w" style="width:100%">
            <div class="ui-tab" >
                <ul class="ui-tab-nav">
                    <li  class="{{#ifEqual type 'all'}}current{{/ifEqual}}" style="border-right:1px solid #ccc">
                        <a href="{{allUrl}}">全部订单{{#ifEqual type 'all'}}({{total}}){{/ifEqual}}</a>
                    </li>
                    <li class="{{#ifEqual type 'wait'}}current{{/ifEqual}}" style="font-size:15px; border-right:1px solid #ccc">
                        <a href="{{waitUrl}}">待处理{{#ifEqual type 'wait'}}({{total}}){{/ifEqual}}</a>
                    </li>
                    <li class="{{#ifEqual type 'finished'}}current{{/ifEqual}}" style="font-size:15px;border-right:1px solid #ccc">
                        <a href="{{finishedUrl}}" >已处理{{#ifEqual type 'finished'}}({{total}}){{/ifEqual}}</a>
                    </li>
                    <li class="{{#ifEqual type 'success'}}current{{/ifEqual}}" style="font-size:15px;">
                        <a href="{{successUrl}}" >转移成功{{#ifEqual type 'success'}}({{total}}){{/ifEqual}}</a>
                    </li>
                </ul>
            </div>
        </div>
