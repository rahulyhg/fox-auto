...
Fox.define('crm:views/calendar/calendar', ['view', 'lib!full-calendar'], function (Dep, FullCalendar) {
    ...
    return Dep.extend({
        ...
        data: function () {
            var scopeFilterList = Fox.Utils.clone(this.scopeList);
        ...
        setup: function () {
            ...
            this.scopeList = this.getMetadata().get('clientDefs.Calendar.scopeList') || Fox.Utils.clone(this.scopeList);
            ...
            if (this.header) {
                this.enabledScopeList = this.getStoredEnabledScopeList() || Fox.Utils.clone(this.scopeList);
            } else {
                this.enabledScopeList = this.options.enabledScopeList || Fox.Utils.clone(this.scopeList);
            }
